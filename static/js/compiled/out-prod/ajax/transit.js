...
ajax.transit.transit_type = (function ajax$transit$transit_type(p__36872){
...
var type = cljs.core.get.call(null,map__36873__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var or__30875__auto__ = type;
...
var writer = (function (){var or__30875__auto__ = new cljs.core.Keyword(null,"writer","writer",-277568236).cljs$core$IFn$_invoke$arity$1(request);
if(cljs.core.truth_(or__30875__auto__)){
return or__30875__auto__;
} else {
...
var reader = (function (){var or__30875__auto__ = new cljs.core.Keyword(null,"reader","reader",169660853).cljs$core$IFn$_invoke$arity$1(request);
if(cljs.core.truth_(or__30875__auto__)){
return or__30875__auto__;
} else {
