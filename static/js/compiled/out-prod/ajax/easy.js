...
var G__36915 = format;
var G__36915__$1 = (((G__36915 instanceof cljs.core.Keyword))?G__36915.fqn:null);
switch (G__36915__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__36917_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__36917_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__36918){
...
var handler = cljs.core.get.call(null,map__36919__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__36919__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__36919__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__30875__auto__ = handler;
...
var e = (function (){var or__30875__auto__ = error_handler;
if(cljs.core.truth_(or__30875__auto__)){
return or__30875__auto__;
} else {
...
return ((function (h,e,map__36919,map__36919__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__36921){
var vec__36922 = p__36921;
var ok = cljs.core.nth.call(null,vec__36922,(0),null);
var result = cljs.core.nth.call(null,vec__36922,(1),null);
...
;})(h,e,map__36919,map__36919__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__36925){
...
var opts = map__36926__$1;
var method = cljs.core.get.call(null,map__36926__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__36926__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__36926__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__36926__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__36926__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = ((body == null)) && (cljs.core.not_EQ_.call(null,method,"GET"));
var rf = (cljs.core.truth_((function (){var or__30875__auto__ = format;
if(cljs.core.truth_(or__30875__auto__)){
return or__30875__auto__;
} else {
return needs_format;
